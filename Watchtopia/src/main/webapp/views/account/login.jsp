...
<body>
			...
			<div class="collapse navbar-collapse" id="navbarText">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					<li class="nav-item"><a class="nav-link active"
						...
						style="font-size: 20px; font-weight: 400;">Đăng Nhập</a></li>
				</ul>
	...
	<div class="container_banner">
		<form class="form_container" action="/account/login" method="post">
			...
			<div class="input_container">
                ...
                <path stroke-linejoin="round" stroke-linecap="round"
						stroke-width="1.5" stroke="#141B34"
				...
				<input placeholder="name@mail.com" name="email" type="email"
					class="input_field" id="email_field" value="${user}">
			...
			<div class="input_container form-check">
				<input type="checkbox" class="form-check-input" id="exampleCheck1"
					...
					class="form-check-label" for="exampleCheck1">Ghi nhớ tài
					khoản?</label>
			</div>
			...
			<div class="input_container">
				<c:if test="${errorEmail == true}">
					<div class="alert alert-danger" role="alert">Nhập sai Email,
						Vui lòng kiểm tra lại Email!</div>
				</c:if>
				<c:if test="${errorPassword == true}">
					<div class="alert alert-danger" role="alert">Nhập sai mật
						khẩu, Vui lòng kiểm tra lại mật khẩu!</div>
				</c:if>
			</div>
			<div class="separator">
				<hr class="line">
			...
			<button title="Sign In" type="submit" class="sign-in_ggl">
				...
				<span> <img
					...
					style="width: 28px;" /> Đăng nhập với Google
				</span>
			</button>
			<button type="submit" class="sign-in_apl">
				<span><img
					src="https://img.icons8.com/fluency/48/null/facebook-new.png"
					style="width: 28px;" /> Đăng nhập với Facebook</span>
			</button>
			<p class="note">
				Bạn mới sử dụng? <a href="/account/register"
					style="color: red; text-decoration: none;">Đăng Ký</a>
			</p>
			<a href="/account/forgetPassword"
				style="color: red; text-decoration: none;">Quên mật khẩu?</a>
		</form>
	</div>
